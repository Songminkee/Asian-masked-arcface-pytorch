...
parser.add_argument(
    "--path",
    type=str,
    default="../dataset/faces_glintasia/images", 
...
parser.add_argument(
    "--code",
    type=str,
    default="cloth-#FFFFFF,cloth,surgical_blue,surgical,surgical-#000000,KN95",#cloth-masks/textures/check/check_4.jpg,cloth-#e54294, cloth-#ff0000, cloth, cloth-masks/textures/others/heart_1.png, cloth-masks/textures/fruits/pineapple.png, N95, surgical_blue, surgical_green",
    #default="",
...
# Process if the path was a file
    ...
    if is_image(image_path):
        ...
        for i in range(len(mask)):
            w_path = write_path +  "." + args.path.rsplit(".")[1] #"_" + mask[i] + "." + args.path.rsplit(".")[1]
            img = masked_image[i]
            cv2.imwrite(w_path, img)
else:
